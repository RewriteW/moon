<template>
  <el-dialog
    ...
    <el-form-item label="可选值类型  [0 - 单选，1 - 多选]" prop="valueType">
      <el-input v-model="dataForm.valueType" placeholder="可选值类型  [0 - 单选，1 - 多选]"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          valueType: [
            { required: true, message: '可选值类型  [0 - 单选，1 - 多选]不能为空', trigger: 'blur' }
          ]
        }
      }
    },
